...
stockdate: _entity?.stockdate,
        ...
        await client.service("stocks").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info stocks updated successfully" });
    ...
    return (
        <Dialog header="Edit Stocks" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="stocks-edit-dialog-component">
